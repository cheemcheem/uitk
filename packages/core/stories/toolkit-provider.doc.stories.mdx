...
You can use `useDensity` hook to access the currently active density of your app in the provided scope.

## useTheme

You can use `useTheme` hook to access the value of the currently active themes.

## useBreakpoints

You can use `useBreakpoints` hook to access the current value of `breakpoints` ToolkitProvider context. This is a low-level hook that is used internally in other hooks such as useResponsiveProp.
