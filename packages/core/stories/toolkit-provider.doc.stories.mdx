...
You can use `useBreakpoints` hook to access the current value of `breakpoints` ToolkitProvider context. This is a low-leve hook that is used internally in other hooks such as useResponsiveProp.
